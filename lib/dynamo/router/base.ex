defmodule Dynamo.Router.InvalidHookError do
  ...
  def message(%{kind: kind, hook: hook, actual: actual}) do
    "expected #{inspect kind} hook #{inspect hook} to return " <>
      "a HTTP connection, but got #{inspect actual}"
  end
end
